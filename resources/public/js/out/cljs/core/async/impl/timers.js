...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12285 = 0;while(true){
if((i_12285 < arr.length))
{(arr[i_12285] = null);
{
var G__12286 = (i_12285 + 1);
i_12285 = G__12286;
continue;
}
} else
...
{var i_12292 = (self__.level + 1);while(true){
if((i_12292 <= (new_level + 1)))
{(update[i_12292] = self__.header);
{
var G__12293 = (i_12292 + 1);
i_12292 = G__12293;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12294 = 0;while(true){
if((i_12294 <= self__.level))
{var links_12295 = (update[i_12294]).forward;if(((links_12295[i_12294]) === x__$1))
{(links_12295[i_12294] = (x__$1.forward[i_12294]));
{
var G__12296 = (i_12294 + 1);
i_12294 = G__12296;
continue;
}
} else
{{
var G__12297 = (i_12294 + 1);
i_12294 = G__12297;
continue;
}
}
