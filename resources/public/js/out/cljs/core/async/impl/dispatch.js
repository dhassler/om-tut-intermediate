...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12320 = 0;while(true){
var m_12321 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12321 == null))
{} else
{m_12321.call(null);
if((count_12320 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12322 = (count_12320 + 1);
count_12320 = G__12322;
continue;
}
} else
{}
